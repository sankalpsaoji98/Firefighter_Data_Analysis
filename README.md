...
Information includes date of the incident, date of death, age, classification (volunteer, career, wildland), cause of fatal injury, nature of fatal injury, task during the fatal injury, and location (city and state) of the firefighter’s department.
